                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () async {
                            ...
                            List<String>? bookmarks = await shr.getBookMarkData();

                            if (bookmarks != null) {
                              bookmarks.add(inAppWebViewController!.getUrl().toString());
                              shr.setBookMark(bookmarks);
                            } else {
                              List<String> newBookmark = [inAppWebViewController!.getUrl().toString()];
                              shr.setBookMark(newBookmark);
                            }
